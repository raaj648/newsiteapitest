// =================================================================================
// SCRIPT.JS - HIGH PERFORMANCE / DARK THEME ONLY
// =================================================================================
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  // === PERFORMANCE (TBT): Defer rendering of off-screen categories ===
  const aboveTheFoldCount = 3; // Render the first 3 categories instantly
  
  // Render above-the-fold categories immediately
  ...
  // Defer rendering of below-the-fold categories to unblock main thread
  setTimeout(() => {
